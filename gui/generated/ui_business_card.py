...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setAccessibleName(QCoreApplication.translate("Form", u"Business Card", None))
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        Form.setAccessibleDescription(QCoreApplication.translate("Form", u"Click to open business details page", None))
#endif // QT_CONFIG(accessibility)
...
#if QT_CONFIG(accessibility)
        self.bookmark_button.setAccessibleName(QCoreApplication.translate("Form", u"Bookmark Button", None))
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        self.bookmark_button.setAccessibleDescription(QCoreApplication.translate("Form", u"Add or remove this business from your bookmarks", None))
#endif // QT_CONFIG(accessibility)
