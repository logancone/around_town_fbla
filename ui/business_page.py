...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 790, 594))
        ...
        self.gridLayout_2.addLayout(self.review_holder, 5, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.review_label, 3, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.add_review_button, 4, 0, 1, 1)
