...
################################################################################
## Form generated from reading UI file 'report_editor.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.user_info.setChecked(True)
        ...
        self.bookmarked_businesses.setChecked(True)
        ...
        self.owned_businesses.setChecked(True)

        self.verticalLayout.addWidget(self.owned_businesses)

        self.review_history = QCheckBox(Dialog)
        self.review_history.setObjectName(u"review_history")
        self.review_history.setChecked(True)

        self.verticalLayout.addWidget(self.review_history)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.review_history.setText(QCoreApplication.translate("Dialog", u"Review History", None))
    # retranslateUi
