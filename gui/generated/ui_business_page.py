...
#if QT_CONFIG(accessibility)
        self.bookmark_button.setAccessibleDescription(QCoreApplication.translate("Form", u"Toggles current bookmarked state", None))
#endif // QT_CONFIG(accessibility)
        self.bookmark_button.setText("")
        self.business_page_title.setText(QCoreApplication.translate("Form", u"Business Title", None))
#if QT_CONFIG(accessibility)
        self.back_button.setAccessibleName(QCoreApplication.translate("Form", u"Back Button", None))
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
